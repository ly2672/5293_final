...
# Location
    ...
    unis = ["Columbia University", "Harvard", "MIT", "Stanford", "UCBerkeley", "UCDavis", "XJTLU"]
    for uni in unis:
        if uni.lower() in user_input.lower():
            if uni == "Columbia University":
                ...
                data["university"] = "University of California, Berkeley"
            elif uni == "UCDavis":
                data["university"] = "University of California, Davis"
            elif uni == "XJTLU":
                data["university"] = "Xi'an Jiaotong-Liverpool University"
